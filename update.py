...
old_data = {"schedule": "データなし", "news": "データなし", "contribution": "データなし"}
...
schedule_result_json = {"schedule": old_data.get("schedule", "データなし"), "indices": indices_data, "news": old_data.get("news", "データなし"), "contribution": old_data.get("contribution", "データなし")}
